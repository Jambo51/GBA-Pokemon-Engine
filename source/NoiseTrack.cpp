...
u8 NoiseTrack::ExecuteCommands(u8 commandID, GBPChannel &masterChannel)
{
	u8 commandLength = 2;
	commandID -= 0xD8;
	if (commandID == 0)
...
void NoiseTrack::Update(u16 tempo, GBPChannel &masterChannel)
{
	if (noteLength1 < 2)
	{
...
void NoiseTrack::WritePattern(GBPChannel &masterChannel)
{
...
void NoiseTrack::ModulateTrack(GBPChannel &masterChannel)
{
}

u16 NoiseTrack::GetModulationPitch(GBPChannel &masterChannel)
{
	return 0;
}

void NoiseTrack::ArpeggiateTrack(GBPChannel &masterChannel)
{
}
...
void NoiseTrack::ExecuteModifications(u8 commandID, u16 tempo, GBPChannel &masterChannel)
{
	u16* tone1Controller = masterChannel.GetBufferAddress();
