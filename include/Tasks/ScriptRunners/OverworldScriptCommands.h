...
extern u32 LockAllInScript(Tasks::ScriptRunners::ScriptRunner* runner);
extern u32 LockInScript(Tasks::ScriptRunners::ScriptRunner* runner);
extern u32 ReleaseAllFromScript(Tasks::ScriptRunners::ScriptRunner* runner);
extern u32 ReleaseFromScript(Tasks::ScriptRunners::ScriptRunner* runner);
extern u32 WaitKeyPress(Tasks::ScriptRunners::ScriptRunner* runner);
extern u32 Multichoice(Tasks::ScriptRunners::ScriptRunner* runner);
extern u32 MultichoiceWithDefault(Tasks::ScriptRunners::ScriptRunner* runner);
