...
const RODATA_LOCATION u16 CGBFreq[] = {
		8013, 7566, 7144, 6742,
		6362, 6005, 5666, 5346,
		5048, 4766, 4499, 4246
	};

const RODATA_LOCATION u16 freq[75] = {
	44,		// C3
	156,
	262,
	363,
...
const RODATA_LOCATION WavePattern patterns[] = {
...
const RODATA_LOCATION ALIGN(1) u8 noiseData00[] = { 0x20, 0x11, 0x00, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData01[] = { 0x20, 0xC1, 0x33, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData02[] = { 0x20, 0xB1, 0x33, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData03[] = { 0x20, 0xA1, 0x33, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData04[] = { 0x20, 0x81, 0x33, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData05[] = { 0x27, 0x84, 0x37, 0x26, 0x84, 0x36, 0x25, 0x83, 0x35, 0x24, 0x83, 0x34, 0x23, 0x82, 0x33, 0x22, 0x81, 0x32, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData06[] = { 0x20, 0x51, 0x2A, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData07[] = { 0x21, 0x41, 0x2B, 0x20, 0x61, 0x2A, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData08[] = { 0x20, 0x81, 0x10, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData09[] = { 0x20, 0x82, 0x23, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData010[] = { 0x20, 0x82, 0x25, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData011[] = { 0x20, 0x82, 0x26, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData012[] = { 0x20, 0xA1, 0x10, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData16[] = { 0x20, 0xA2, 0x11, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData17[] = { 0x20, 0xA2, 0x50, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData18[] = { 0x20, 0xA1, 0x18, 0x20, 0x31, 0x33, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData19[] = { 0x22, 0x91, 0x28, 0x20, 0x71, 0x18, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData110[] = { 0x20, 0x91, 0x22, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData111[] = { 0x20, 0x71, 0x22, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData112[] = { 0x20, 0x61, 0x22, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData30[] = { 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData31[] = { 0x20, 0x91, 0x33, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData32[] = { 0x20, 0x51, 0x32, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData33[] = { 0x20, 0x81, 0x31, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData34[] = { 0x20, 0x88, 0x6B, 0x20, 0x71, 0x00, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData35[] = { 0x30, 0x91, 0x18, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData36[] = { 0x20, 0x11, 0x11, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData37[] = { 0x27, 0x92, 0x10, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData38[] = { 0x33, 0x91, 0x00, 0x33, 0x11, 0x00, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData39[] = { 0x33, 0x91, 0x11, 0x33, 0x11, 0x00, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData311[] = { 0x20, 0xA8, 0x6B, 0x20, 0x71, 0x00, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData312[] = { 0x20, 0x84, 0x12, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData45[] = { 0x20, 0xA1, 0x31, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData47[] = { 0x33, 0x81, 0x00, 0x33, 0x11, 0x00, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData48[] = { 0x33, 0x51, 0x21, 0x33, 0x11, 0x11, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData49[] = { 0x33, 0x51, 0x50, 0x33, 0x11, 0x11, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData410[] = { 0x33, 0x81, 0x21, 0x33, 0x11, 0x11, 0xFF };
const RODATA_LOCATION ALIGN(1) u8 noiseData412[] = { 0x33, 0x88, 0x15, 0x20, 0x65, 0x12, 0xFF };
