...
void WaveTrack::ExecuteModifications(u8 commandID, u16 tempo, GBPChannel &masterChannel)
{
...
void WaveTrack::ModulateTrack(GBPChannel &masterChannel)
{
	u16* tone1Controller = masterChannel.GetBufferAddress();
...
u16 WaveTrack::GetModulationPitch(GBPChannel &masterChannel)
{
	return 0;
}

void WaveTrack::ArpeggiateTrack(GBPChannel &masterChannel)
{
}

u8 WaveTrack::ExecuteCommands(u8 commandID, GBPChannel &masterChannel)
{
	u8 commandLength = 1;
...
void WaveTrack::Update(u16 tempo, GBPChannel &masterChannel)
{
	if (noteLength1 < 2)
	{
