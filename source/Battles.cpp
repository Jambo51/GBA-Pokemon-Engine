...
RODATA_LOCATION ALIGN(4) TrainerClassMusic BattleScreen::classValues[] = { { Class_Evil_Team, Song_TeamRocketBattle }, { Class_Evil_Team_Duo, Song_TeamRocketBattle }, { Class_Rival, Song_RBYTrainerBattle }, { 0xFFFF, 0x0000 } };
