...
#include "Scenes/Battles/DoubleTrainerBattle.h"
		...
		void DoubleTrainerBattle::Update()
		{
			...
			switch (currentStatus)
			{
				...
				case 5:
				{
					...
					{
						Core::Pokemon::Pokemon* thePokemon = Core::Pokemon::Pokemon::GenerateTrainerPokemon(data[0].pokemonData[currentStatus].species, data[0].pokemonData[currentStatus].level, (char*)&data[0].name, battleData.trainerData[0].trainerID, 0);
				...
				}
				{
					...
					{
						Core::Pokemon::Pokemon* thePokemon = Core::Pokemon::Pokemon::GenerateTrainerPokemon(data[0].pokemonData[currentStatus - 6].species, data[0].pokemonData[currentStatus - 6].level, (char*)&data[0].name, battleData.trainerData[0].trainerID, 0);
						if (data[0].battleVarietyBits.isHeldItemsBattle)
						{
							if (data[0].battleVarietyBits.isMovesetBattle)
							{
