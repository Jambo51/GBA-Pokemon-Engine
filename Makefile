...
BUILD		:= build
SRCDIRS		:= source source/Allocation source/Tasks source/Tasks/ScriptRunners source/Callbacks source/Text source/Core source/Core/Data source/Core/Pokemon source/Audio source/Audio/GameBoySounds source/Audio/M4A source/Entities source/Scenes source/Scenes/Battles source/Scenes/Menus source/Scenes/Overworld source/Input source/Input/Battles source/Input/Menus source/Input/Overworld source/Data source/Data/TitleScreen source/Data/Tilesets
DATADIRS	:= 
INCDIRS		:= include
